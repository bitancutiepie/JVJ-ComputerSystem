...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#f1f5f9] text-slate-900 selection:bg-blue-100 selection:text-blue-900 font-sans pb-32 lg:pl-56">
      ...
      {showWelcome && (
        <div className="fixed inset-0 z-[200] bg-slate-900/60 backdrop-blur-xl flex items-center justify-center p-4 animate-fade-in">
          <div className="w-full max-w-2xl bg-white rounded-[3rem] shadow-[0_40px_100px_rgba(0,0,0,0.3)] overflow-hidden relative border border-white animate-slide-down">
            <button 
              onClick={closeWelcome}
              className="absolute top-8 right-8 p-2 hover:bg-slate-100 rounded-full transition-all text-slate-400 hover:text-slate-900 z-10"
            >
              <X className="w-6 h-6" />
            </button>
